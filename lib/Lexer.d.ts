...
export declare type LexerRule<T> = [boolean, RegExp, T, (LexerRule<T>[] | 'push' | 'pop')?];
export declare type LexerState<T> = LexerRule<T>[];
export declare function buildLexer<T>(rules: LexerState<T>): Lexer<T>;
